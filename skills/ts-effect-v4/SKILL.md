---
name: ts-effect-v4
description: Canonical handbook for Effect v4 in TypeScript. Use for Effect code on effect@4 / beta — imports from effect/unstable/*, Context.Service, Effect.fn, Schema.TaggedErrorClass, single-versioned @effect/* packages. For effect@3, use ts-effect-v3 instead.
---
