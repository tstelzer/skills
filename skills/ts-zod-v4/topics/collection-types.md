...
- Avoid `z.looseRecord(...)` at untrusted boundaries; non-matching keys pass through without validation.
...
const PhoneFields = z.record(z.string().regex(/_phone$/), z.e164())
...
- Treating values passed through by `looseRecord` as parsed or trusted
